...
**For Azure Active Directory sign-in activities, why are errors because of UserAccountNotFound not present in the Audit logs?**

Audit logs read from Azure AD Event Hubs starting from Dec 2020, and sign-in errors because of UserAccountNotFound are not available in those Azure AD Event Hubs, so they are not present in Azure Active Directory sign-in activities any more. 
